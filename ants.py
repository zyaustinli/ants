...
# END Problem 12
    ...
    def action(self, gamestate):
        ...
        while curr_pos!=None:
            if curr_pos.ant != None:
            
                if not curr_pos.ant.is_doubled:
                    curr_pos.ant.double()
                    curr_pos.ant.is_doubled =True
                if curr_pos.ant.is_container:
                    if curr_pos.ant.ant_contained!=None:
                        if not curr_pos.ant.ant_contained.is_doubled:
                            curr_pos.ant.ant_contained.double()
                            curr_pos.ant.ant_contained.is_doubled =True
                
            curr_pos=curr_pos.exit
        # END Problem 12
